...
BG = pygame.transform.scale(
    pygame.image.load("background.jpg"), (WINDOW_WIDTH, WINDOW_HEIGHT))
PLANET = pygame.transform.scale(
    pygame.image.load("planet.png"), (PLANET_SIZE * 3, PLANET_SIZE * 3))
...
def main():
    ...
    while running:
        ...
        for obj in objects[:]:
            obj.draw()
            obj.move(planet)
            off_screen = obj.x < 0 or obj.x > WINDOW_WIDTH or obj.y < 0 or obj.y > WINDOW_HEIGHT
